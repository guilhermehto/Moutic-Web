            ...
            <div class="tab-pane active" id="tab-general">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-festa">Festa</label>
                  <div class="col-sm-10">
                    <input type="text" name="festa" value="Festa" placeholder="Festa" id="input-festa" class="form-control" />
                  </div>
                </div>
              ...
              <fieldset>
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="festa" value="Festa" placeholder="Festa" id="input-festa" class="form-control" />
                    <select name="festa" id="input-festa" class="form-control">
                      <?php foreach($festas as $festa) { ?>
                        <option value="<?php echo $festa['customer_id'] ?>"><?php echo $festa['name'] ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div>
